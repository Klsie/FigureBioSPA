                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div>
                                    <p class="mb-0">No tienes cuenta? <a href="registro.php" class="text-white-50 fw-bold">Registrate</a></p>
                                    <p class="mb-0">Regresar a Inicio <a href="../index.php" class="text-white-50 fw-bold">Inicio</a></p>
                                    <p class="mb-0">Administrador <a href="../adm/sesion.php" class="text-white-50 fw-bold">Inicio</a></p>
                                </div>
...
if ($_POST) {
    ...
    $servidor = "biofigurespa-server.mysql.database.azure.com";
    $usuario = "pclfdrfdz";  // Sin el @servidor (Azure lo maneja automáticamente)
    $password = "auY2FAoUB5KTD$4V";
    $base_datos = "biofigurespa-database";
    $puerto = 3306;
    ...
    $Resultado = mysqli_query($Conexion, "SELECT * FROM `usuario`
     WHERE `correoUsuari` = '$Nombre' AND `pswUsuario` = '$Passw'");
    if (mysqli_num_rows($Resultado)) {
        $fila = mysqli_fetch_assoc($Resultado);
        $nombreDesdeBD = $fila['nombreUsuario']; 
        $idUsuarioDesdeBD = $fila['correoUsuari'];
        echo '<span>Bienvenido</span>';

        $_SESSION["usuario"] = "$nombreDesdeBD";
        $_SESSION["idUsuario"] = "$idUsuarioDesdeBD";
