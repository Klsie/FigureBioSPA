            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card bg-dark text-white" style="border-radius: 15px;">
                    <div class="card-body p-5 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">MODIFICAR Sucursales</h3>
                            <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" id="idSucursal" name="idSucursal" class="form-control form-control-lg" placeholder="" required />
                                    <label class="form-label" for="idSucursal">Id Sucursal</label>
...
if ($_POST) {
        ...
        $query = ("UPDATE `sucursal` SET `idSucursal` = '$Id', `domicilio` =  ' $Domicilio', `horarioSucursal` = ' $Horario' WHERE `sucursal`.`idSucursal` = $Id;");
