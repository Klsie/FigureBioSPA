                        ...
                        <div class="col-12 col-lg-9 col-xl-7">
                            <div class="card bg-dark text-white" style="border-radius: 15px;">
                                <div class="card-body p-5 p-md-5">
                                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">SUCURSALES QUE SE HAN AGREGADO</h3>
...
<?php
    ...
    while ($row = mysqli_fetch_array($Resultado)) {
        echo '<tr><td><h5>' . $row['idSucursal'] . '</h5></td>';
        echo '<td><h5>' . $row['domicilio'] . '</h5></td>';
        echo '<td><h5>' . $row['horarioSucursal'] . '</h5></td>';
        echo '</form>';
    }
