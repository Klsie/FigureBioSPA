                        ...
                        <div class="col-12 col-lg-9 col-xl-7">
                            <div class="card bg-dark text-white" style="border-radius: 15px;">
                                <div class="card-body p-5 p-md-5">
                                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">AGREGAR ARTICULOS</h3>
                                        <div class="row">
...
if ($_POST) {
    ...
    if ($SubirArchivos == true) {
        ...
        $Resultado = mysqli_query($Conexion, "INSERT INTO `producto` (`idProducto`,`nombreProducto`,`cantidadProducto`,`precioProducto`,`imagenProducto`)
        VALUES (null,'".$Nombre."','".$Exsist."','".$Precio."','".$name."');");
        if ($Resultado == true) {
