...
<body class="body">
        ...
        <div class="container-fluid">';
                    ...
                    <button type="button" class="btn btn-dark btn-lg"><a href="admin.php" style="text-decoration:none">Empleados</a></button>
        ...
        <div class="col-12 col-lg-9 col-xl-7">
            <div class="card bg-dark text-white" style="border-radius: 15px;">
                <div class="card-body p-5 p-md-5">
                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">ELIMINAR EMPLEADO POR ID</h3>
...
if (isset($_POST['Eliminar'])) {
    ...
    $conexion = mysqli_connect("localhost", "root", "") or die("Error en la conexion de la base de datos ");
    mysqli_select_db($conexion, "global") or die("Error en la base de datos");
    $Resultado = mysqli_query($conexion, "DELETE FROM `global`.`empleado` WHERE `empleado`.`idEmpleado` = '$nombre'");
    if ($Resultado == true) {
